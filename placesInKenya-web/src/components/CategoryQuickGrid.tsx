        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          {categories.map((cat) => (
            <button
              ...
              className="group flex flex-col items-center gap-4 p-5 bg-navy/[0.02] hover:bg-white hover:shadow-lg hover:-translate-y-1 transition-all rounded-2xl border border-navy/5 hover:border-safari/30 tap-target"
            >
